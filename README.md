...
**_Current actively developed versions are 1.12.2, 1.16.5 and 1.17.1._**\
Other versions might get an update in rare cases, but the main development is focused on these three. Some mods might not have an 1.12.2 version if the code is too different.
