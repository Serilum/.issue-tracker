...
package com.natamus.superflatworldnoslimes.util;

public class Reference {
	public static final String MOD_ID = "superflatworldnoslimes-fabric";
	public static final String NAME = "Superflat World No Slimes (Fabric)";
