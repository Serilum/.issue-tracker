 ...
 * Minecraft version: 1.19.x, mod version: 3.5.
 *
...
package com.natamus.healingcampfire.util;

public class Reference {
	public static final String MOD_ID = "healingcampfire-fabric";
	public static final String NAME = "Healing Campfire (Fabric)";
