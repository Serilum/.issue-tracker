...
package com.natamus.spidersproducewebs.util;

public class Reference {
	public static final String MOD_ID = "spidersproducewebs-fabric";
	public static final String NAME = "Spiders Produce Webs (Fabric)";
