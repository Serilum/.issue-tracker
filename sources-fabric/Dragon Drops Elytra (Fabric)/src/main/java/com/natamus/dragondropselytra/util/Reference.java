...
package com.natamus.dragondropselytra.util;

public class Reference {
	public static final String MOD_ID = "dragondropselytra-fabric";
	public static final String NAME = "Dragon Drops Elytra (Fabric)";
