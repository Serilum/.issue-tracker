...
package com.natamus.zombieproofdoors.util;

public class Reference {
	public static final String MOD_ID = "zombieproofdoors-fabric";
	public static final String NAME = "Zombie Proof Doors (Fabric)";
