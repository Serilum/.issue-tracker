...
public class ConfigHandler extends DuskConfig {
	@Comment public static Comment DESC_timeInTicksToRespawn;
	@Entry public static int timeInTicksToRespawn = 1200;
	@Comment public static Comment RANGE_timeInTicksToRespawn;

	@Comment public static Comment DESC_shulkersFromSpawnersDoNotRespawn;
