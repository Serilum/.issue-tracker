...
package com.natamus.playerdeathkick.util;

public class Reference {
	public static final String MOD_ID = "playerdeathkick-fabric";
	public static final String NAME = "Player Death Kick (Fabric)";
