...
public class ConfigHandler extends DuskConfig {
	@Comment public static Comment DESC_disableFollowerDamageAfterTeleport;
	@Entry public static boolean disableFollowerDamageAfterTeleport = true;

	@Comment public static Comment DESC_durationInSecondsDamageShouldBeDisabled;
	@Entry public static int durationInSecondsDamageShouldBeDisabled = 20;
	@Comment public static Comment RANGE_durationInSecondsDamageShouldBeDisabled;
}