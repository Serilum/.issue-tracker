...
public class ConfigHandler extends DuskConfig {
	@Comment public static Comment DESC_firstJoinMessage;
	@Entry public static String firstJoinMessage = "You wake up in an unfamiliar place.";

	@Comment public static Comment DESC_firstJoinMessageTextFormattingColourIndex;
	@Entry public static int firstJoinMessageTextFormattingColourIndex = 2;
	@Comment public static Comment RANGE_firstJoinMessageTextFormattingColourIndex;
}