 ...
 * Minecraft version: 1.18.x, mod version: 2.3.
 *
...
package com.natamus.despawningeggshatch.util;

public class Reference {
	public static final String MOD_ID = "despawningeggshatch-fabric";
	public static final String NAME = "Despawning Eggs Hatch (Fabric)";
