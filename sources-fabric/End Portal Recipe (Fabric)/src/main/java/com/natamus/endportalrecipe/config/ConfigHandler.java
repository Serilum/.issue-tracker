...
public class ConfigHandler extends DuskConfig {
	@Comment public static Comment DESC_mustHaveSilkTouchToBreakPortal;
	@Entry public static boolean mustHaveSilkTouchToBreakPortal = true;

	@Comment public static Comment DESC_addBrokenPortalFramesToInventory;
	@Entry public static boolean addBrokenPortalFramesToInventory = true;

	@Comment public static Comment DESC_sendMessageOnExtraDragonEggDrop;
