...
package com.natamus.surfacemushrooms.util;

public class Reference {
	public static final String MOD_ID = "surfacemushrooms-fabric";
	public static final String NAME = "Surface Mushrooms (Fabric)";
