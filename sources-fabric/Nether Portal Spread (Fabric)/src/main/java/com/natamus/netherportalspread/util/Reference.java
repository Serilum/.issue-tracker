 ...
 * Minecraft version: 1.19.x, mod version: 5.7.
 *
...
public class Reference {
	public static final String MOD_ID = "netherportalspread-fabric";
	public static final String NAME = "Nether Portal Spread (Fabric)";
