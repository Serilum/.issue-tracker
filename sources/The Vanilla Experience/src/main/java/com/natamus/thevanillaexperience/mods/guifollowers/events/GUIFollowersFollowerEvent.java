...
public class GUIFollowersFollowerEvent {
	...
	public void onPlayerTick(PlayerTickEvent e) {
		...
		if (player.ticksExisted % (20* GUIFollowersConfigHandler.GENERAL.timeBetweenChecksInSeconds.get()) != 0) {
			return;
		}
	...
	public void onKey(InputEvent.KeyInputEvent e) {
		...
		if (e.getKey() == GUIFollowersVariables.clearlist_hotkey.getKey().getKeyCode()) {
			GUIFollowersVariables.activefollowers = new ArrayList<Entity>();
		}
	}
}
