...
package com.natamus.thevanillaexperience.mods.randomsheepcolours.util;
...
public class RandomSheepColoursUtil {
	public static List<DyeColor> possibleColours = null;
	
	public static void initColours() {
		possibleColours = new ArrayList<DyeColor>();
		
		String possiblecolours = RandomSheepColoursConfigHandler.GENERAL.possibleSheepColours.get();
