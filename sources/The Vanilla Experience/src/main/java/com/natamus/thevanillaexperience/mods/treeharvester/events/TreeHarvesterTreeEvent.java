...
public class TreeHarvesterTreeEvent {
	...
	public void onTreeHarvest(BlockEvent.BreakEvent e) {
		...
		if (TreeHarvesterConfigHandler.GENERAL.enableFastLeafDecay.get() && !TreeHarvesterConfigHandler.GENERAL.instantBreakLeavesAround.get()) {
			...
			Iterator<BlockPos> possiblelogs = BlockPos.getAllInBoxMutable(bpos.getX()-8, bpos.getY(), bpos.getZ()-8, bpos.getX()+8, TreeHarvesterUtil.highestleaf.get(bpos), bpos.getZ()+8).iterator();
			...
			Iterator<BlockPos> possibleleaves = BlockPos.getAllInBoxMutable(bpos.getX()-h, bpos.getY(), bpos.getZ()-h, bpos.getX()+h, TreeHarvesterUtil.highestleaf.get(bpos), bpos.getZ()+h).iterator();
