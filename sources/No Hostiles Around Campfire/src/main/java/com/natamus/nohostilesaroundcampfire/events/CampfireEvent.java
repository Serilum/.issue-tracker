...
public class CampfireEvent {
	...
	public void onEntityJoin(LivingSpawnEvent.CheckSpawn e) {
		...
		List<BlockPos> nearbycampfires = FABFunctions.getAllTileEntityPositionsNearbyEntity(TileEntityType.CAMPFIRE, ConfigHandler.GENERAL.preventHostilesRadius.get(), world, entity);
