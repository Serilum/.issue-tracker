...
public class Util {
	...
	private static void sendSpreadingMessage(World world, BlockPos p) {
		...
		StringFunctions.sendMessageToPlayersAround(world, p, ConfigHandler.GENERAL.portalSpreadRadius.get(), formatAroundString(message, ConfigHandler.GENERAL.preventSpreadBlockAmountNeeded.get(), p), TextFormatting.RED);
	}
	...
	private static void sendPreventedMessage(World world, BlockPos p) {
		...
		StringFunctions.sendMessageToPlayersAround(world, p, ConfigHandler.GENERAL.portalSpreadRadius.get(), formatAroundString(message, ConfigHandler.GENERAL.preventSpreadBlockAmountNeeded.get(), p), TextFormatting.DARK_GREEN);	
	}
