 ...
 * Minecraft version: 1.18.2, mod version: 2.8.
 *
...
public class Main {
    ...
    private void loadComplete(final FMLLoadCompleteEvent event) {
    	...
    	new SAMObject(EntityType.ZOMBIE, EntityType.GIANT, null, ConfigHandler.GENERAL.chanceSurfaceZombieIsGiant.get(), false, false, ConfigHandler.GENERAL.onlySpawnGiantOnSurface.get());
	}
}