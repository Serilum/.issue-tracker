...
public class Main {
    ...
    private void loadComplete(final FMLLoadCompleteEvent event) {
        MinecraftForge.EVENT_BUS.register(new StructureProtectionEvents());
    	MinecraftForge.EVENT_BUS.register(new StructureCreationEvents());
        MinecraftForge.EVENT_BUS.register(new StructureSpawnPointEvents());
	}
}